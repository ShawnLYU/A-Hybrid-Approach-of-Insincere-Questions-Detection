...
Another feature that we intend to add to our analysis is the sentiment measurement from TextBlob library. One main type of insincere question is questions with non-neutral tone, so we believe that directly feeding sentiment information to our model would be beneficial. 
