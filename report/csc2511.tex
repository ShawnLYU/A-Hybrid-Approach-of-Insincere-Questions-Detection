...
\begin{figure}[ht] 
	\centering
	\subfloat[noun]{\includegraphics[width=0.5\textwidth]{graphs/noun_box.png}}
	\subfloat[verb]{\includegraphics[width=0.5\textwidth]{graphs/verb_box.png}}
...
In addition to the statistical data, we also plan to visualize the word embeddings of labeled and unlabeled sentences. Consider the size of our corpus, we will first extract the most frequent unigrams, and visualize the corresponding word vectors using appropriate methods such as t-SNE plots. 
